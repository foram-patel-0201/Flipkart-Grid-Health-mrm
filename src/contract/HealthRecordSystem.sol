...
contract HealthRecordSystem {
    ...
    function addUser(string memory abhaId, string memory role, string memory passwordHash , string memory name)
        public
    {
        users[abhaId] = User(role, passwordHash ,name);
    }

    function verifyPassword(string memory abhaId, string memory password)
        public
        view
        returns (string[2] memory) 
    {
        if (keccak256(bytes(users[abhaId].passwordHash)) == keccak256(bytes(password)))
        {
    ...
    function getUserData(string memory abhaId)
        public
        view
        returns (string[2] memory)
    {
    ...
    function getMedicalRecords(string memory abhaID)
        public
        view
        returns (MedicalRecord[] memory)
    {
    ...
    function searchByDoctor(string memory doctor)
        public
        view
        returns (MedicalRecord[] memory)
    {
    ...
    function searchByDocumentType(string memory documentType)
        public
        view
        returns (MedicalRecord[] memory)
    {
    ...
    function searchByHospitalName(string memory hospitalName)
        public
        view
        returns (MedicalRecord[] memory)
    {
    ...
    function searchByDate(string memory date)
        public
        view
        returns (MedicalRecord[] memory)
    {
